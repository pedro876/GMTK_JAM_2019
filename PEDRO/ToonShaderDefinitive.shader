Shader "Custom/ToonShaderDefinitive"
{
	Properties
	{
		...
		_UseSpecular("UseSpecular1to0", Float) = 0
		...
		SubShader
		{
			Pass
			{
				...
				float4 frag(vertexOutput IN) : SV_Target
				{
					...
					float4 finalColor = (sample * _Color * finalLight * _LightColor0 + sample * _AmbientColor *(1 - finalLight)) + volumetricAdd * _LightColor0;
					finalColor.a = 1;
					return finalColor;
				}
				ENDCG
